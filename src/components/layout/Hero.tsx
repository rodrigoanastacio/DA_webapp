    ...
    <section className="relative py-24 md:py-32 from-blue-50/50 via-white to-white border-gray-100 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          {/* Badge */}
          <FadeIn delay={0.1}>
            <div className="inline-flex items-center gap-2 px-6 py-2 mb-8 text-sm font-bold text-blue-700 bg-white border border-blue-100 rounded-full cursor-default shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <FadeIn delay={0.4}>
            <p className="mb-10 text-xl text-gray-600 max-w-2xl leading-relaxed">
              ...
              para escritórios e advogados que buscam crescimento sustentável.
            </p>
          </FadeIn>
          ...
          <ScaleIn delay={0.6}>
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              >
                Fazer diagnóstico gratuito do meu escritório
              </Link>
            </div>
          </ScaleIn>
        </div>
