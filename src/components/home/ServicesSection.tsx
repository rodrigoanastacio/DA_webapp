...
const services = [
  {
    ...
    title: 'Gestão GERAR',
    description:
      'Diagnóstico completo e reestruturação de processos internos para escritórios que buscam eficiência e qualidade técnica.',
  ...
  },
  {
    ...
    description:
      'Planejamento de crescimento detalhado, definição de metas e KPIs para uma tomada de decisão baseada em dados reais.',
  ...
  },
  {
    ...
    title: 'Plano de Ação',
    description:
      'Desenvolvimento da mentalidade de "Advogado CEO", liderança e gestão de equipes de alta performance.',
    ...
    <section className="py-24 bg-stone-50" id="servicos">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 space-y-4">
          ...
          >
            Soluções para quem quer{' '}
            <span className="text-amber-900">parar de apagar incêndios</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Estruture seu escritório para crescer sem depender 100% da sua
