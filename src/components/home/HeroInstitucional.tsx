        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-col justify-center space-y-6 pt-10 pb-16 md:py-28 lg:pr-16">
              <FadeIn delay={0.1}>
                <motion.div
                  className="inline-flex items-center gap-2 px-5 py-2 text-sm font-semibold text-brand-gold bg-brand-gold/10 backdrop-blur-sm border border-brand-gold/20 rounded-full cursor-default shadow-amber-100 w-fit"
                ...
                >
                  ...
                  >
                    ...
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-brand-gold/80" />
                  </span>
